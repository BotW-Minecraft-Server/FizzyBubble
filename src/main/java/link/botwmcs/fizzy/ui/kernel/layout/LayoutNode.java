...
abstract class LayoutNode {
    ...
    final void render(LayoutMountContext context, GuiGraphics graphics, float partialTick, LayoutRect bounds) {
        onRender(context, graphics, partialTick, bounds);
    }

    protected abstract void onMount(LayoutMountContext context, LayoutRect bounds);

    protected abstract void onRender(LayoutMountContext context, GuiGraphics graphics, float partialTick, LayoutRect bounds);
